<?php
	function form($incompleteId,$projectTitle,$principalInvestigator,$coprincipalInvestigators,$principalInvestigatorDept,$principalInvestigatorPhone,$principalInvestigatorEmail,$principalInvestigatorFax,$externalGrant,$hsrcExemption,$demographicA,$demographicB,$demographicC,$demographicD,$demographicF,$demographicG,$Risk,$RiskYes,$ConfidentialityA,$ConfidentialityB,$ConfidentialityCi,$ConfidentialityCii,$ConfidentialityCiii,$BenefitsA,$BenefitsB,$exclusion,$extension, $procedurerows_array){
?>
		<html>
		   <head>
        ...
        var extension=$("#extension").val(); 
         ...
         /**
		   ...
		   <body>
			  <div id="container">
				 ...
				 <div id="content">
					...
					<form id="myForm" name="irbForm" method="POST" onsubmit="return formValidation()" enctype="multipart/form-data" >
					   Title of Project: <input type="text" name="projecttitle" value="<?php echo $projectTitle ?>" maxlength="100"/>
					   <p>
					   ...
					   <p>
                  <!-- <input type="submit" size="90" name='submit' value="Submit Completed Form"/> -->
                  <button value ="Submit"  
			  ...
			  <footer id="footer">
			  <div>
			<a class="button" type="button" name='save' onclick='avoidValidation(); saveAjax(); return false;' formnovalidate href="#popup1">Save Progress</a>
			...
			<a class="close" href="#">&times;</a>
				...
				<b> <h3>Copyright &copy; 2016 ASHESI UNIVERSITY COLLEGE IRB BOARD  <h3> </b>
			  </footer>
		   </body>
		</html>
<?php
	...
	$user1= new save;
	if (isset($_REQUEST['incompleteId'])) {
		$uc = $_REQUEST['incompleteId'];
		$result = $user1->getDetails($uc);
		$row= $user1->fetch();
		if ($row) {
			...
			$procedurerows_array = explode(",", $_REQUEST["procedurerows"]);
			} else {
			echo "No Results";
			}
			form($incompleteId,$projectTitle,$principalInvestigator,$coprincipalInvestigators,$principalInvestigatorDept,$principalInvestigatorPhone,$principalInvestigatorEmail,$principalInvestigatorFax,$externalGrant,$hsrcExemption,$demographicA,$demographicB,$demographicC,$demographicD,$demographicF,$demographicG,$Risk,$RiskYes,$ConfidentialityA,$ConfidentialityB,$ConfidentialityCi,$ConfidentialityCii,$ConfidentialityCiii,$BenefitsA,$BenefitsB,$exclusion,$extension, $procedurerows_array);
	} else {
