...
var ProjectTitle=$("#ProjectTitle").val();  
				var ajaxPageUrl="submitFormajax.php?cmd=1&ProjectTitle="+ProjectTitle; 
				$.ajax(ajaxPageUrl,
	 ...
	 <body>
      <div id="container">
         ...
         <div id="content">
            ...
            <p>
          <!--   <form action="submitForm_ajax_example.php" method="GET"> -->
               Title of Project: <input type="text" id="ProjectTitle"  maxlength="100"/>
               <p>
                  Principal Investigator: <input type="text" name="PrincipalInvestigator"  maxlength="100"/>
               <p>
                  Co-Principal Investigator(s):<input type="text" name="username"  maxlength="100"/>
               <p>
                  Principal Investigator Department <input type="text" name="username"  maxlength="100"/>
               <p>
                  Principal Investigator Phone <input type="text" name="username"  maxlength="100"/>
               <p>
                  Email<input type="text" name="username"  maxlength="100"/>
                  Fax <input type="text" name="username"  maxlength="100"/>
               <p>
               ...
               <p>
                  Grant:<input type="text" name="username"  maxlength="100"/>
               <p>
               ...
               <p>
                  :<input type="text" name="username" size="100" maxlength="100"/>
               <p>
               ...
               <p> :<input type="text" name="username" size="100" maxlength="100"/>
               <p>
               ...
               <p>h1:<input type="text" name="username" size="100" maxlength="100"/>
               <p>
               ...
               <div>
                  ...
                  <input type="checkbox" value="1" name="permission[]"> Deception of the participant?
                  <p>
                     <input type="checkbox" value="2" name="permission[]"> Punishment of the participant?
                  <p>
                  ...
                  <p>   
                     ...
                     invasion of privacy?
                  <p>   
                     <input type="checkbox" value="3" name="permission[]">Disclosure of the name of individual participants?
                  <p>   
                     <input type="checkbox" value="3" name="permission[]">Any other physically invasive procedure?
                  <p>   
               </div>
               ...
               <p> :<input type="text" name="username" maxlength="100"/>
               <p>
               ...
               <p>B. Ashesi Academic Program Review Data. Data collected for the purpose of the evaluation, review, and improvement of Ashesi University academic and extra-curricular programs is exempt from review unless these data are collected: 1) for use beyond program review (e.g. publication), and/or 2) for publication beyond the review process for Ashesi programs administered by Ashesi, by its associated accrediting agencies, and by other related educational bodies. Program Review research proposals that meet the criteria for exemption from review do not need to be sent to the Ashesi HSRC, however, it is advisable to do so as a courtesy and also to provide pre-project approval in case that decisions about external dissemination or publication change during the course of the project.fo
